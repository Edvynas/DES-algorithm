...
namespace DES
{
    class Tables
    {
        ...
        public int GetCompression(int n)
        {
            return cpt[n];
        }
        ...
        public int GetSBox(int n, int k)
        {
            return sbox[n, k];
        }
        //P Box Table  
        ...
        public int GetFinalPermutation(int n)
        {
            return fp[n];
        }
    }
